            ...
            <div className="flex items-center">
                <div className="flex items-center mr-4">
                    <Link to="/dashboard-coupons" className=" md:block hidden">
                        <AiOutlineGift size={30} color="#555" className="cursor-pointer mx-5" title="Discount Codes" />
                    </Link>
                    <Link to="/dashboard-events" className=" md:block hidden">
                        <MdOutlineLocalOffer size={30} color="#555" className="cursor-pointer mx-5" title="All Events" />
                    </Link>
                    <Link to="/dashboard-products" className=" md:block hidden">
                        <FiShoppingBag size={30} color="#555" className="cursor-pointer mx-5" title="Products" />
                    </Link>
                    <Link to="/dashboard-orders" className=" md:block hidden">
                        <FiPackage size={30} color="#555" className="cursor-pointer mx-5" title="Orders" />
                    </Link>
                    <Link to="/dashboard-messages" className=" md:block hidden">
                        <BiMessageSquareDetail size={30} color="#555" className="cursor-pointer mx-5" title="Messages" />
                    </Link>
