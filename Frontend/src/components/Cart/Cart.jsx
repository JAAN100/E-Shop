        ...
        <div className="fixed top-0 left-0 w-full h-screen bg-[#0000004b] z-35">
            <div className="fixed top-0 right-0 min-h-full w-[25%] bg-white flex flex-col justify-between">
                ...
                <div className="px-5 mb-3">
                    {/* Checkout button */}
                    <Link to="/checkout">
                        <div className="w-full h-[45px] flex items-center justify-center bg-[#332ac8] rounded-[3px]">
                            <h1 className="text-white text-[18px] font-[600]">Proceed to Checkout USD${cartData[0].price}</h1>
                        </div>
                    </Link>
                </div>
            </div>
        ...
        <div className="border-b p-4">
            <div className="w-full- flex items-center">
                <div>
                    ...
                    <div
                        className="bg-[#8b90984f] rounded-full w-[25px] h-[25px] flex items-center justify-center cursor-pointer"
                        onClick={() => {
                ...
                <div className="pl-[5px]">
                    ...
                    <h3 className="font-[600] text-[17px] text-[#d02222]">US${totalPrice}</h3>
                </div>
